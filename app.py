...
# Ensure GOOGLE_CREDENTIALS is set in the environment and contains the JSON key as a string
credentials_info = json.loads(os.environ['GOOGLE_CREDENTIALS'])
credentials = Credentials.from_service_account_info(credentials_info, scopes=SCOPES)

# Create a service object to interact with the Google Sheets API
